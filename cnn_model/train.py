...
if __name__ == '__main__':
    ...
    model.fit(train_data, train_labels, batch_size=64, nb_epoch=20, verbose=1,
              validation_data=(test_data, test_labels),
              callbacks=[ModelCheckpoint('./cnn_model/trained_model.h5', monitor='val_loss', verbose=1, save_best_only=True,
